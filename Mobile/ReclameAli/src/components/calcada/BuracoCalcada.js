...
import BuracoNaCalcada from "../../img/imgsCalcada/buraco.png"

export default function BuracoCalcada() {
      ...
      <View style={styles.cabecalho}>
        <View style={styles.btnetxt}>
          <Ionicons 
            ...
            />
          <Text style={styles.title}>Buracos na calçada</Text>
        </View>
        ...
        <View style={{alignItems:"center", justifyContent:"center", padding:25, marginVertical:50}}>
          <View style={{display:"flex", flexDirection:"row", alignItems:"flex-start", marginBottom:30, justifyContent:"space-around"}}>
            <Image source={BuracoNaCalcada} style={{height:60, width:60}}/>
            <TextInput
              placeholder='Título'
